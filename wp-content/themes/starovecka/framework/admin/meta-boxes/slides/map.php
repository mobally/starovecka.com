...
$qodeFramework->qodeMetaBoxes->addMetaBox('svg', $qodeSlideSvg);
	...
	$qode_slide_svg_source = new QodeMetaField('textarea', 'qode_slide_svg_source', '', 'SVG source code', 'Paste SVG source code. (Note: all CSS styling for SVG you may put in Starovecka Options > General > Custom SVG CSS)');
