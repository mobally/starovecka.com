...
function qode_theme_menu() {
	...
	init_qode_theme_options();
      ...
      'Starovecka Options',                   // The value used to populate the browser's title bar when the menu page is active
      'Starovecka Options',                   // The text of the menu in the administrator's sidebar
	...
	foreach ($qodeFramework->qodeOptions->adminPages as $key=>$value ) {
    	...
    	$subpage_hook_suffix = add_submenu_page(
    		'qode_theme_menu',
	        'Starovecka Options - '.$value->title,                   // The value used to populate the browser's title bar when the menu page is active
...
if(!function_exists('qode_add_theme_options_toolbar')) {
    /**
     * Adds a link to Starovecka Options in toolbar for easier access
